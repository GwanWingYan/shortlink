<template>
    <div class="login-page">
        <h1 class="title">Shortlink 短链接</h1>
        <div class="login-box">
            <!-- 登录 -->
                ...
                <el-form ref="loginFormRef1" :model="loginForm" label-width="50px" :rules="loginFormRule">
                    <div class="form-container1">
                        <el-form-item prop="phone">
                            <el-input v-model="loginForm.userName" placeholder="请输入用户名" maxlength="11" show-word-limit
                                clearable>
                        ...
                        <el-form-item prop="password">
                            <el-input v-model="loginForm.password" type="password" clearable placeholder="请输入密码"
                                show-password style="margin-top: 20px">
            ...
            <div class="register" :class="{ hidden: isLogin }">
                ...
                <el-form ref="loginFormRef2" :model="addForm" label-width="50px" class="form-container" width="width"
                    ...
                    <el-form-item prop="userName">
                        <el-input v-model="addForm.userName" placeholder="请输入用户名" maxlength="11" show-word-limit
                            clearable>
                            <template v-slot:prepend> 用户名 </template>
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item prop="password">
                        <el-input v-model="addForm.password" type="password" clearable placeholder="请输入密码"
                            show-password>
                            <template v-slot:prepend> 密<span class="second-font">码</span> </template>
                        </el-input>
                    </el-form-item>
...
const login = (formEl) => {
    ...
    formEl.validate(async (valid) => {
        if (valid) {
            ...
            } else if (res1.data.message === '用户不存在或密码错误') {
                ElMessage.error('请输入正确的账号密码!')
            } else {
                ElMessage.error('用户登录错误!')
            }
        } else {
            return false
        }
